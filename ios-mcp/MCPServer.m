...
static NSDictionary *MCPRandomizedTapPointForElement(NSDictionary *element) {
    ...
    // Constrain the random tap range: only randomize within the center region of the rect.
    // 0.5 means the middle 50% region.
    // For example, rect: x=0 y=0 width=80 height=40
    // Final random region: x=20 y=10 width=40 height=20
...
- (NSDictionary *)handleToolsList:(id)reqId {
    NSArray *tools = @[
        ...
        @{
            ...
            @"description": @"Get device information including model, iOS version, battery level, storage, memory, and system/package information",
            @"inputSchema": @{
                @"type": @"object",
                @"properties": @{
