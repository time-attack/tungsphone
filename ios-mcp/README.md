...
iOS MCP is an [MCP (Model Context Protocol)](https://modelcontextprotocol.io) server that runs on the iPhone, enabling AI agents (Claude, Codex, Cursor, etc.) to directly control iOS devices.
...
| **Device Info** | `get_device_info` | Model, iOS version, battery, storage, memory, system info |
...
- An iPhone or iPad running iOS 13 – iOS 18

## Installation

### Supported Environments

| Variant | Supported iOS Versions | Package Architecture |
|------|------|------|
...
#### Method 2: Install directly from a package manager

You can also search for and install the package directly:
